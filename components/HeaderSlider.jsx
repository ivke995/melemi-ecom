...
const HeaderSlider = () => {
  const sliderData = [
    {
      id: 1,
      title: "Prirodni melem za lice i tijelo — nježna njega svaki dan!",
    ...
    {
      id: 2,
      title: "Prirodna noćna krema za regeneraciju kože tokom sna",
    ...
    {
      id: 3,
      title: "Prirodna pjena za nježno čišćenje lica svaki dan",
