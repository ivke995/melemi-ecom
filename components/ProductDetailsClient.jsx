...
const ProductDetailsClient = ({ product, featuredProducts = [] }) => {
  const { addToCart, router, currency, getProductPrice } = useAppContext();
  ...
  const volumeMl = product?.volumeMl;
      ...
      <div className="flex flex-col items-center">
        <div className="flex flex-col items-center mb-4 mt-16">
          <p className="text-3xl font-medium">
            Izdvojeni <span className="font-medium text-orange-600">proizvodi</span>
          </p>
