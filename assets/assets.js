...
import logo from "./Screenshot_from_2025-10-16_17-59-53-removebg-preview.png";
...
import header_slider_first from "./header-slider-first.png";
import header_slider_second from "./header-slider-second.png";
import header_slider_third from "./header-slider-third.png";
...
export const productsDummyData = [
  {
    ...
    description:
      "Apple AirPods Pro (2. generacija) sa MagSafe futrolom (USB-C) nude odličan zvuk, aktivno poništavanje buke i udobno pristajanje. USB-C futrola omogućava brzo punjenje, a slušalice se besprijekorno povezuju s Apple uređajima za bezbrižno audio iskustvo.",
    price: 499.99,
    offerPrice: 399.99,
    image: [
  ...
  },
  {
    ...
    name: "PlayStation 5",
    description:
      "PlayStation 5 podiže gejming na viši nivo uz ultra-HD grafiku, moćni 825GB SSD i ray tracing tehnologiju za realistične prikaze. Bilo da volite akciju ili imerzivne priče, PS5 donosi brzo učitavanje, glatku igru i zadivljujuće vizuale. Neophodan je za svakog ozbiljnog gejmera koji želi vrhunsko iskustvo.",
    price: 599.99,
    offerPrice: 499.99,
    image: [
  ...
  },
  {
    ...
    name: "Canon EOS R5",
    description:
      "Canon EOS R5 je revolucionarna mirrorless kamera sa 45MP full-frame senzorom, koja nudi ultra-visoku rezoluciju i mogućnost snimanja 8K videa. Bilo da snimate profesionalne fotografije ili filmske kadrove, ova kamera pruža izuzetnu oštrinu, brzinu i tačnost boja. Uz napredni autofokus i stabilizaciju u tijelu, R5 je idealna za fotografe i videografe.",
    price: 4199.99,
    offerPrice: 3899.99,
    image: [
  ...
  },
  {
    ...
    description:
      "Samsung 4K projektor pruža imerzivno bioskopsko iskustvo uz ultra-visoku rezoluciju i realističnu tačnost boja. Sa ugrađenim zvučnikom isporučuje bogat zvuk koji prati zadivljujući 4K prikaz. Idealan je za filmske večeri, gejming ili prezentacije, te je odličan izbor za kućni bioskop ili profesionalno okruženje.",
    price: 1699.99,
    offerPrice: 1499.99,
    image: [
  ...
  },
  {
    ...
    description:
      "Gejming laptop ASUS ROG Zephyrus G16 pokreće Intel Core i9 procesor i RTX 4070 GPU, pružajući vrhunske performanse. Sa 16GB RAM-a i 1TB SSD-om, dizajniran je za gejmere koji traže ekstremnu snagu, brzinu i prostor za skladištenje. Opremljen je zadivljujućim 16-inčnim ekranom i spreman je za najzahtjevnije naslove i aplikacije.",
    price: 2199.99,
    offerPrice: 1999.99,
    image: [
